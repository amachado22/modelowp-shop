...
class Mobisale_Admin_Theme {
	...
	function admin_bar(){
		...
		foreach ( $all_toolbar_nodes as $node ) {
			...
			if($args->id == "site-name"){
				$logo = "<img src='".plugin_dir_url('')."/mobsale-ui-theme/resources/logo-mob.svg'>";
	...
	function login() {
		...
		body.login div#login h1 {
	        background-image: url('https://mobsale.com.br/wp-content/uploads/2021/08/icon_MOBsale.png');
...
function custom_loginlogo() {
	...
	h1 a {background-image: url('.get_bloginfo('template_directory').'/images/login_logo1.png) !important; }
	</style>';
}
